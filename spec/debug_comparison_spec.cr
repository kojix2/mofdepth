...
describe "Debug comparison with mosdepth" do
  ...
  it "debugs basic coverage calculation" do
    ...
    puts "\n--- Running moffdepth ---"
    moffdepth_result = run_moffdepth_debug([] of String, "#{temp_dir}/moffdepth_test", temp_dir, test_bam)
    ...
    puts "moffdepth success: #{moffdepth_result.success?}"
  end
end
